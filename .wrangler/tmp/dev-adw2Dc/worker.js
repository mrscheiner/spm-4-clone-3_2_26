...
// .wrangler/tmp/bundle-lAkX71/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-lAkX71/middleware-insertion-facade.js
init_modules_watch_stub();
...
// backend/trpc/routes/sportsdataio-helper.ts
init_modules_watch_stub();
...
var sportsdataRouter = createTRPCRouter({
  ...
  getLeagueScheduleAllTeams: publicProcedure.input(anyType()).query(async ({ input, ctx }) => {
    ...
    let requestedAbbr = parsedInput.teamAbbreviation ? String(parsedInput.teamAbbreviation).toUpperCase() : void 0;
    ...
    for (const t2 of teams) {
      const abbrs = t2.abbreviation === "GS" ? ["GS", "GSW"] : [t2.abbreviation];
