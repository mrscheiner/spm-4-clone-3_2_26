...
// .wrangler/tmp/bundle-2HkAi9/checked-fetch.js
...
// .wrangler/tmp/bundle-2HkAi9/strip-cf-connecting-ip-header.js
...
function getHTTPStatusCode(json) {
  ...
  const httpStatuses = new Set(arr.map((res) => {
    if ("error" in res && isObject(res.error.data)) {
      var _res$error$data;
      if (typeof ((_res$error$data = res.error.data) === null || _res$error$data === void 0 ? void 0 : _res$error$data["httpStatus"]) === "number")
...
var init_initTRPC_RoZMIBeA = __esm({
  "node_modules/@trpc/server/dist/initTRPC-RoZMIBeA.mjs"() {
    ...
    StandardSchemaV1Error = /* @__PURE__ */ __name(class extends Error {
      /**
      ...
      function _objectWithoutProperties$1(e, t2) {
        ...
        if (Object.getOwnPropertySymbols) {
          ...
          for (r = 0; r < s.length; r++)
            o = s[r], t2.includes(o) || {}.propertyIsEnumerable.call(e, o) && (i[o] = e[o]);
        }
        return i;
      }
...
`.trim();
    ...
    TRPCBuilder = /* @__PURE__ */ __name(class TRPCBuilder2 {
      /**
  ...
  "trpc/routes/espn.ts"() {
    ...
    espnRouter = createTRPCRouter({
      ...
      getFullSchedule: publicProcedure.input(
        ...
        if (seasonInfo.altSeason)
          seasonsToTry.push(seasonInfo.altSeason);
        if (seasonInfo.additionalSeasons)
          seasonsToTry.push(...seasonInfo.additionalSeasons);
...
// .wrangler/tmp/bundle-2HkAi9/middleware-loader.entry.ts
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();

// .wrangler/tmp/bundle-2HkAi9/middleware-insertion-facade.js
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
...
var Unpromise = /* @__PURE__ */ __name(class Unpromise2 {
  constructor(arg) {
...
var MaxDepthError = /* @__PURE__ */ __name(class extends Error {
  constructor(path) {
    ...
    if (!info.isBatchCall) {
      ...
      switch (info.type) {
        ...
        case "query": {
          ...
          if (isDataStream(result === null || result === void 0 ? void 0 : result.data))
            throw new TRPCError({
              code: "UNSUPPORTED_MEDIA_TYPE",
