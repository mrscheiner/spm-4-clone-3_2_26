...
// .wrangler/tmp/bundle-rcpt9V/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-rcpt9V/middleware-insertion-facade.js
init_modules_watch_stub();
...
var isDeep = /* @__PURE__ */ __name((object, superJson) => isPlainObject2(object) || isArray(object) || isMap(object) || isSet(object) || isError(object) || isInstanceOfRegisteredClass(object, superJson), "isDeep");
...
// trpc/routes/sportsdataio-helper.ts
init_modules_watch_stub();
var import_node_fetch = __toESM(require_browser());
async function sportsdataioFetch({ league, endpoint, params = {}, apiKey, method = "GET", version = "v3" }) {
...
async function getDefaultSeasonYear(league, apiKey) {
...
__name(getDefaultSeasonYear, "getDefaultSeasonYear");
async function loadLeagueScheduleAllTeams(league, apiKey, log = () => {
}) {
  let seasonYear = await getDefaultSeasonYear(league, apiKey);
  let gamesPRE = [], gamesREG = [];
  let found = false;
  for (let i = 0; i < 3; ++i) {
  ...
  const allGames = [];
  const addGames = /* @__PURE__ */ __name((arr, seasonType) => {
    for (const g of arr || []) {
...
__name(loadLeagueScheduleAllTeams, "loadLeagueScheduleAllTeams");
function testHomeFiltering(result) {
...
__name(testHomeFiltering, "testHomeFiltering");
...
var NBA_TEAMS = [
  ...
  { id: "gsw", name: "Golden State Warriors", leagueId: "nba", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/0/01/Golden_State_Warriors_logo.svg/200px-Golden_State_Warriors_logo.svg.png", primaryColor: "#1D428A", secondaryColor: "#FFC72C", city: "San Francisco", abbreviation: "GSW" },
...
var NFL_TEAMS = [
  { id: "ari-nfl", name: "Arizona Cardinals", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/7/72/Arizona_Cardinals_logo.svg/200px-Arizona_Cardinals_logo.svg.png", primaryColor: "#97233F", secondaryColor: "#000000", city: "Glendale", abbreviation: "ARI" },
  { id: "atl-nfl", name: "Atlanta Falcons", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/c/c5/Atlanta_Falcons_logo.svg/200px-Atlanta_Falcons_logo.svg.png", primaryColor: "#A71930", secondaryColor: "#000000", city: "Atlanta", abbreviation: "ATL" },
  { id: "bal", name: "Baltimore Ravens", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/1/16/Baltimore_Ravens_logo.svg/200px-Baltimore_Ravens_logo.svg.png", primaryColor: "#241773", secondaryColor: "#9E7C0C", city: "Baltimore", abbreviation: "BAL" },
  { id: "buf-nfl", name: "Buffalo Bills", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/7/77/Buffalo_Bills_logo.svg/200px-Buffalo_Bills_logo.svg.png", primaryColor: "#00338D", secondaryColor: "#C60C30", city: "Orchard Park", abbreviation: "BUF" },
  { id: "car-nfl", name: "Carolina Panthers", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/1/1c/Carolina_Panthers_logo.svg/200px-Carolina_Panthers_logo.svg.png", primaryColor: "#0085CA", secondaryColor: "#101820", city: "Charlotte", abbreviation: "CAR" },
  { id: "chi-nfl", name: "Chicago Bears", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Chicago_Bears_logo.svg/200px-Chicago_Bears_logo.svg.png", primaryColor: "#0B162A", secondaryColor: "#C83803", city: "Chicago", abbreviation: "CHI" },
  { id: "cin", name: "Cincinnati Bengals", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/81/Cincinnati_Bengals_logo.svg/200px-Cincinnati_Bengals_logo.svg.png", primaryColor: "#FB4F14", secondaryColor: "#000000", city: "Cincinnati", abbreviation: "CIN" },
  { id: "cle-nfl", name: "Cleveland Browns", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/d/d9/Cleveland_Browns_logo.svg/200px-Cleveland_Browns_logo.svg.png", primaryColor: "#311D00", secondaryColor: "#FF3C00", city: "Cleveland", abbreviation: "CLE" },
  { id: "dal-nfl", name: "Dallas Cowboys", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Dallas_Cowboys.svg/200px-Dallas_Cowboys.svg.png", primaryColor: "#003594", secondaryColor: "#869397", city: "Arlington", abbreviation: "DAL" },
  { id: "den-nfl", name: "Denver Broncos", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/4/44/Denver_Broncos_logo.svg/200px-Denver_Broncos_logo.svg.png", primaryColor: "#FB4F14", secondaryColor: "#002244", city: "Denver", abbreviation: "DEN" },
  { id: "det-nfl", name: "Detroit Lions", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/7/71/Detroit_Lions_logo.svg/200px-Detroit_Lions_logo.svg.png", primaryColor: "#0076B6", secondaryColor: "#B0B7BC", city: "Detroit", abbreviation: "DET" },
  { id: "gb", name: "Green Bay Packers", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/50/Green_Bay_Packers_logo.svg/200px-Green_Bay_Packers_logo.svg.png", primaryColor: "#203731", secondaryColor: "#FFB612", city: "Green Bay", abbreviation: "GB" },
  { id: "hou-nfl", name: "Houston Texans", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/2/28/Houston_Texans_logo.svg/200px-Houston_Texans_logo.svg.png", primaryColor: "#03202F", secondaryColor: "#A71930", city: "Houston", abbreviation: "HOU" },
  { id: "ind-nfl", name: "Indianapolis Colts", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/00/Indianapolis_Colts_logo.svg/200px-Indianapolis_Colts_logo.svg.png", primaryColor: "#002C5F", secondaryColor: "#A2AAAD", city: "Indianapolis", abbreviation: "IND" },
  { id: "jax", name: "Jacksonville Jaguars", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/7/74/Jacksonville_Jaguars_logo.svg/200px-Jacksonville_Jaguars_logo.svg.png", primaryColor: "#101820", secondaryColor: "#D7A22A", city: "Jacksonville", abbreviation: "JAX" },
  { id: "kc", name: "Kansas City Chiefs", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/e/e1/Kansas_City_Chiefs_logo.svg/200px-Kansas_City_Chiefs_logo.svg.png", primaryColor: "#E31837", secondaryColor: "#FFB81C", city: "Kansas City", abbreviation: "KC" },
  { id: "lv", name: "Las Vegas Raiders", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/4/48/Las_Vegas_Raiders_logo.svg/200px-Las_Vegas_Raiders_logo.svg.png", primaryColor: "#000000", secondaryColor: "#A5ACAF", city: "Las Vegas", abbreviation: "LV" },
  { id: "lac-nfl", name: "Los Angeles Chargers", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/a/a6/Los_Angeles_Chargers_logo.svg/200px-Los_Angeles_Chargers_logo.svg.png", primaryColor: "#0080C6", secondaryColor: "#FFC20E", city: "Inglewood", abbreviation: "LAC" },
  { id: "lar", name: "Los Angeles Rams", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/8/8a/Los_Angeles_Rams_logo.svg/200px-Los_Angeles_Rams_logo.svg.png", primaryColor: "#003594", secondaryColor: "#FFA300", city: "Inglewood", abbreviation: "LAR" },
  { id: "mia-nfl", name: "Miami Dolphins", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/3/37/Miami_Dolphins_logo.svg/200px-Miami_Dolphins_logo.svg.png", primaryColor: "#008E97", secondaryColor: "#FC4C02", city: "Miami Gardens", abbreviation: "MIA" },
  { id: "min-nfl", name: "Minnesota Vikings", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/4/48/Minnesota_Vikings_logo.svg/200px-Minnesota_Vikings_logo.svg.png", primaryColor: "#4F2683", secondaryColor: "#FFC62F", city: "Minneapolis", abbreviation: "MIN" },
  { id: "ne", name: "New England Patriots", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/b/b9/New_England_Patriots_logo.svg/200px-New_England_Patriots_logo.svg.png", primaryColor: "#002244", secondaryColor: "#C60C30", city: "Foxborough", abbreviation: "NE" },
  { id: "no", name: "New Orleans Saints", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/50/New_Orleans_Saints_logo.svg/200px-New_Orleans_Saints_logo.svg.png", primaryColor: "#D3BC8D", secondaryColor: "#101820", city: "New Orleans", abbreviation: "NO" },
  { id: "nyg", name: "New York Giants", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/New_York_Giants_logo.svg/200px-New_York_Giants_logo.svg.png", primaryColor: "#0B2265", secondaryColor: "#A71930", city: "East Rutherford", abbreviation: "NYG" },
  { id: "nyj", name: "New York Jets", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/6/6b/New_York_Jets_logo.svg/200px-New_York_Jets_logo.svg.png", primaryColor: "#125740", secondaryColor: "#000000", city: "East Rutherford", abbreviation: "NYJ" },
  { id: "phi-nfl", name: "Philadelphia Eagles", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/8/8e/Philadelphia_Eagles_logo.svg/200px-Philadelphia_Eagles_logo.svg.png", primaryColor: "#004C54", secondaryColor: "#A5ACAF", city: "Philadelphia", abbreviation: "PHI" },
  { id: "pit-nfl", name: "Pittsburgh Steelers", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/de/Pittsburgh_Steelers_logo.svg/200px-Pittsburgh_Steelers_logo.svg.png", primaryColor: "#FFB612", secondaryColor: "#101820", city: "Pittsburgh", abbreviation: "PIT" },
  { id: "sf", name: "San Francisco 49ers", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/San_Francisco_49ers_logo.svg/200px-San_Francisco_49ers_logo.svg.png", primaryColor: "#AA0000", secondaryColor: "#B3995D", city: "Santa Clara", abbreviation: "SF" },
  { id: "sea-nfl", name: "Seattle Seahawks", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/8/8e/Seattle_Seahawks_logo.svg/200px-Seattle_Seahawks_logo.svg.png", primaryColor: "#002244", secondaryColor: "#69BE28", city: "Seattle", abbreviation: "SEA" },
  { id: "tb", name: "Tampa Bay Buccaneers", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/a/a2/Tampa_Bay_Buccaneers_logo.svg/200px-Tampa_Bay_Buccaneers_logo.svg.png", primaryColor: "#D50A0A", secondaryColor: "#FF7900", city: "Tampa", abbreviation: "TB" },
  { id: "ten", name: "Tennessee Titans", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/c/c1/Tennessee_Titans_logo.svg/200px-Tennessee_Titans_logo.svg.png", primaryColor: "#0C2340", secondaryColor: "#4B92DB", city: "Nashville", abbreviation: "TEN" },
  { id: "was-nfl", name: "Washington Commanders", leagueId: "nfl", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/Washington_Commanders_logo.svg/200px-Washington_Commanders_logo.svg.png", primaryColor: "#5A1414", secondaryColor: "#FFB612", city: "Landover", abbreviation: "WAS" }
];
var MLB_TEAMS = [
  { id: "ari-mlb", name: "Arizona Diamondbacks", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/8/89/Arizona_Diamondbacks_logo.svg/200px-Arizona_Diamondbacks_logo.svg.png", primaryColor: "#A71930", secondaryColor: "#E3D4AD", city: "Phoenix", abbreviation: "ARI" },
  { id: "atl-mlb", name: "Atlanta Braves", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/f/f2/Atlanta_Braves.svg/200px-Atlanta_Braves.svg.png", primaryColor: "#CE1141", secondaryColor: "#13274F", city: "Atlanta", abbreviation: "ATL" },
  { id: "bal-mlb", name: "Baltimore Orioles", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/7/75/Baltimore_Orioles_cap.svg/200px-Baltimore_Orioles_cap.svg.png", primaryColor: "#DF4601", secondaryColor: "#000000", city: "Baltimore", abbreviation: "BAL" },
  { id: "bos-mlb", name: "Boston Red Sox", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/6/6d/RedSoxPrimary_HangingSocks.svg/200px-RedSoxPrimary_HangingSocks.svg.png", primaryColor: "#BD3039", secondaryColor: "#0C2340", city: "Boston", abbreviation: "BOS" },
  { id: "chc", name: "Chicago Cubs", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/80/Chicago_Cubs_logo.svg/200px-Chicago_Cubs_logo.svg.png", primaryColor: "#0E3386", secondaryColor: "#CC3433", city: "Chicago", abbreviation: "CHC" },
  { id: "cws", name: "Chicago White Sox", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Chicago_White_Sox.svg/200px-Chicago_White_Sox.svg.png", primaryColor: "#27251F", secondaryColor: "#C4CED4", city: "Chicago", abbreviation: "CWS" },
  { id: "cin-mlb", name: "Cincinnati Reds", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/Cincinnati_Reds_Logo.svg/200px-Cincinnati_Reds_Logo.svg.png", primaryColor: "#C6011F", secondaryColor: "#000000", city: "Cincinnati", abbreviation: "CIN" },
  { id: "cle-mlb", name: "Cleveland Guardians", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Cleveland_Guardians_primary_logo.svg/200px-Cleveland_Guardians_primary_logo.svg.png", primaryColor: "#00385D", secondaryColor: "#E50022", city: "Cleveland", abbreviation: "CLE" },
  { id: "col-mlb", name: "Colorado Rockies", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/31/Colorado_Rockies_logo.svg/200px-Colorado_Rockies_logo.svg.png", primaryColor: "#33006F", secondaryColor: "#C4CED4", city: "Denver", abbreviation: "COL" },
  { id: "det-mlb", name: "Detroit Tigers", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e3/Detroit_Tigers_logo.svg/200px-Detroit_Tigers_logo.svg.png", primaryColor: "#0C2340", secondaryColor: "#FA4616", city: "Detroit", abbreviation: "DET" },
  { id: "hou-mlb", name: "Houston Astros", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/Houston-Astros-Logo.svg/200px-Houston-Astros-Logo.svg.png", primaryColor: "#002D62", secondaryColor: "#EB6E1F", city: "Houston", abbreviation: "HOU" },
  { id: "kc-mlb", name: "Kansas City Royals", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/1/1c/Kansas_City_Royals.svg/200px-Kansas_City_Royals.svg.png", primaryColor: "#004687", secondaryColor: "#BD9B60", city: "Kansas City", abbreviation: "KC" },
  { id: "laa", name: "Los Angeles Angels", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8b/Los_Angeles_Angels_of_Anaheim.svg/200px-Los_Angeles_Angels_of_Anaheim.svg.png", primaryColor: "#BA0021", secondaryColor: "#003263", city: "Anaheim", abbreviation: "LAA" },
  { id: "lad", name: "Los Angeles Dodgers", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Los_Angeles_Dodgers_Logo.svg/200px-Los_Angeles_Dodgers_Logo.svg.png", primaryColor: "#005A9C", secondaryColor: "#EF3E42", city: "Los Angeles", abbreviation: "LAD" },
  { id: "mia-mlb", name: "Miami Marlins", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/f/fd/Marlins_team_logo.svg/200px-Marlins_team_logo.svg.png", primaryColor: "#00A3E0", secondaryColor: "#EF3340", city: "Miami", abbreviation: "MIA" },
  { id: "mil-mlb", name: "Milwaukee Brewers", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/b/b8/Milwaukee_Brewers_logo.svg/200px-Milwaukee_Brewers_logo.svg.png", primaryColor: "#12284B", secondaryColor: "#B6922E", city: "Milwaukee", abbreviation: "MIL" },
  { id: "min-mlb", name: "Minnesota Twins", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Minnesota_Twins_logo_%282023%29.svg/200px-Minnesota_Twins_logo_%282023%29.svg.png", primaryColor: "#002B5C", secondaryColor: "#D31145", city: "Minneapolis", abbreviation: "MIN" },
  { id: "nym", name: "New York Mets", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/7/7b/New_York_Mets.svg/200px-New_York_Mets.svg.png", primaryColor: "#002D72", secondaryColor: "#FF5910", city: "New York", abbreviation: "NYM" },
  { id: "nyy", name: "New York Yankees", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f9/New_York_Yankees_Insignia.svg/200px-New_York_Yankees_Insignia.svg.png", primaryColor: "#003087", secondaryColor: "#E4002C", city: "New York", abbreviation: "NYY" },
  { id: "oak", name: "Oakland Athletics", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Oakland_A%27s_logo.svg/200px-Oakland_A%27s_logo.svg.png", primaryColor: "#003831", secondaryColor: "#EFB21E", city: "Oakland", abbreviation: "OAK" },
  { id: "phi-mlb", name: "Philadelphia Phillies", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/f/f0/Philadelphia_Phillies_%282019%29_logo.svg/200px-Philadelphia_Phillies_%282019%29_logo.svg.png", primaryColor: "#E81828", secondaryColor: "#002D72", city: "Philadelphia", abbreviation: "PHI" },
  { id: "pit-mlb", name: "Pittsburgh Pirates", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/81/Pittsburgh_Pirates_logo_2014.svg/200px-Pittsburgh_Pirates_logo_2014.svg.png", primaryColor: "#27251F", secondaryColor: "#FDB827", city: "Pittsburgh", abbreviation: "PIT" },
  { id: "sd", name: "San Diego Padres", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a1/San_Diego_Padres_logo.svg/200px-San_Diego_Padres_logo.svg.png", primaryColor: "#2F241D", secondaryColor: "#FFC425", city: "San Diego", abbreviation: "SD" },
  { id: "sf-mlb", name: "San Francisco Giants", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/5/58/San_Francisco_Giants_Logo.svg/200px-San_Francisco_Giants_Logo.svg.png", primaryColor: "#FD5A1E", secondaryColor: "#27251F", city: "San Francisco", abbreviation: "SF" },
  { id: "sea-mlb", name: "Seattle Mariners", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/6/6d/Seattle_Mariners_logo_%28low_res%29.svg/200px-Seattle_Mariners_logo_%28low_res%29.svg.png", primaryColor: "#0C2C56", secondaryColor: "#005C5C", city: "Seattle", abbreviation: "SEA" },
  { id: "stl-mlb", name: "St. Louis Cardinals", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/9/9d/St._Louis_Cardinals_logo.svg/200px-St._Louis_Cardinals_logo.svg.png", primaryColor: "#C41E3A", secondaryColor: "#0C2340", city: "St. Louis", abbreviation: "STL" },
  { id: "tb-mlb", name: "Tampa Bay Rays", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/c/c6/Tampa_Bay_Rays.svg/200px-Tampa_Bay_Rays.svg.png", primaryColor: "#092C5C", secondaryColor: "#8FBCE6", city: "St. Petersburg", abbreviation: "TB" },
  { id: "tex", name: "Texas Rangers", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/4/41/Texas_Rangers.svg/200px-Texas_Rangers.svg.png", primaryColor: "#003278", secondaryColor: "#C0111F", city: "Arlington", abbreviation: "TEX" },
  { id: "tor-mlb", name: "Toronto Blue Jays", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/b/ba/Toronto_Blue_Jays_logo.svg/200px-Toronto_Blue_Jays_logo.svg.png", primaryColor: "#134A8E", secondaryColor: "#1D2D5C", city: "Toronto", abbreviation: "TOR" },
  { id: "was-mlb", name: "Washington Nationals", leagueId: "mlb", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a3/Washington_Nationals_logo.svg/200px-Washington_Nationals_logo.svg.png", primaryColor: "#AB0003", secondaryColor: "#14225A", city: "Washington", abbreviation: "WSH" }
];
var MLS_TEAMS = [
  { id: "atl-utd", name: "Atlanta United FC", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/6/64/Atlanta_United_FC_logo_2017.svg/200px-Atlanta_United_FC_logo_2017.svg.png", primaryColor: "#80000A", secondaryColor: "#221F1F", city: "Atlanta", abbreviation: "ATL" },
  { id: "aus-fc", name: "Austin FC", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/3/38/Austin_FC_logo.svg/200px-Austin_FC_logo.svg.png", primaryColor: "#00B140", secondaryColor: "#000000", city: "Austin", abbreviation: "ATX" },
  { id: "cha-fc", name: "Charlotte FC", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/e/e1/Charlotte_FC_logo.svg/200px-Charlotte_FC_logo.svg.png", primaryColor: "#1A85C8", secondaryColor: "#000000", city: "Charlotte", abbreviation: "CLT" },
  { id: "chi-fire", name: "Chicago Fire FC", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/f/f4/Chicago_Fire_FC_logo_%282022%29.svg/200px-Chicago_Fire_FC_logo_%282022%29.svg.png", primaryColor: "#C8102E", secondaryColor: "#7CCDEF", city: "Chicago", abbreviation: "CHI" },
  { id: "cin-fc", name: "FC Cincinnati", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/0/08/FC_Cincinnati_primary_logo_2018.svg/200px-FC_Cincinnati_primary_logo_2018.svg.png", primaryColor: "#F05323", secondaryColor: "#263B80", city: "Cincinnati", abbreviation: "CIN" },
  { id: "col-rapids", name: "Colorado Rapids", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/2/2b/Colorado_Rapids_logo.svg/200px-Colorado_Rapids_logo.svg.png", primaryColor: "#862633", secondaryColor: "#8BB8E8", city: "Commerce City", abbreviation: "COL" },
  { id: "cbus-crew", name: "Columbus Crew", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/4/47/Columbus_Crew_SC_logo.svg/200px-Columbus_Crew_SC_logo.svg.png", primaryColor: "#000000", secondaryColor: "#FFE667", city: "Columbus", abbreviation: "CLB" },
  { id: "dc-utd", name: "D.C. United", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/8/89/D.C._United_logo_%282024%29.svg/200px-D.C._United_logo_%282024%29.svg.png", primaryColor: "#000000", secondaryColor: "#EF3E42", city: "Washington", abbreviation: "DC" },
  { id: "dal-fc", name: "FC Dallas", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/c/c9/FC_Dallas_logo.svg/200px-FC_Dallas_logo.svg.png", primaryColor: "#BF0D3E", secondaryColor: "#FFFFFF", city: "Frisco", abbreviation: "DAL" },
  { id: "hou-dynamo", name: "Houston Dynamo FC", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/7/77/Houston_Dynamo_FC_logo.svg/200px-Houston_Dynamo_FC_logo.svg.png", primaryColor: "#F68712", secondaryColor: "#101820", city: "Houston", abbreviation: "HOU" },
  { id: "inter-mia", name: "Inter Miami CF", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/8/81/Inter_Miami_CF_logo.svg/200px-Inter_Miami_CF_logo.svg.png", primaryColor: "#F5B5C8", secondaryColor: "#231F20", city: "Fort Lauderdale", abbreviation: "MIA" },
  { id: "lafc", name: "Los Angeles FC", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/e/e2/Los_Angeles_FC_logo.svg/200px-Los_Angeles_FC_logo.svg.png", primaryColor: "#000000", secondaryColor: "#C39E6D", city: "Los Angeles", abbreviation: "LAFC" },
  { id: "la-galaxy", name: "LA Galaxy", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/6/64/LA_Galaxy_logo.svg/200px-LA_Galaxy_logo.svg.png", primaryColor: "#00245D", secondaryColor: "#FFD200", city: "Carson", abbreviation: "LA" },
  { id: "min-utd", name: "Minnesota United FC", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/0/0e/Minnesota_United_FC_logo.svg/200px-Minnesota_United_FC_logo.svg.png", primaryColor: "#8CD0F0", secondaryColor: "#231F20", city: "Saint Paul", abbreviation: "MIN" },
  { id: "mtl-cf", name: "CF Montr\xE9al", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/0/0f/CF_Montr%C3%A9al.svg/200px-CF_Montr%C3%A9al.svg.png", primaryColor: "#0033A1", secondaryColor: "#000000", city: "Montreal", abbreviation: "MTL" },
  { id: "nsh-sc", name: "Nashville SC", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/1/1e/Nashville_SC_MLS_2020.svg/200px-Nashville_SC_MLS_2020.svg.png", primaryColor: "#ECE83A", secondaryColor: "#1F1646", city: "Nashville", abbreviation: "NSH" },
  { id: "ne-rev", name: "New England Revolution", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/0/0c/New_England_Revolution_%282021%29_logo.svg/200px-New_England_Revolution_%282021%29_logo.svg.png", primaryColor: "#0A2240", secondaryColor: "#CE0E2D", city: "Foxborough", abbreviation: "NE" },
  { id: "nyc-fc", name: "New York City FC", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/0/0f/New_York_City_FC_logo.svg/200px-New_York_City_FC_logo.svg.png", primaryColor: "#6CACE4", secondaryColor: "#F15524", city: "New York", abbreviation: "NYC" },
  { id: "ny-rb", name: "New York Red Bulls", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/3/32/New_York_Red_Bulls_logo.svg/200px-New_York_Red_Bulls_logo.svg.png", primaryColor: "#ED1E36", secondaryColor: "#FFCD00", city: "Harrison", abbreviation: "RBNY" },
  { id: "orl-city", name: "Orlando City SC", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/4/43/Orlando_City_Logo.svg/200px-Orlando_City_Logo.svg.png", primaryColor: "#633492", secondaryColor: "#FDE192", city: "Orlando", abbreviation: "ORL" },
  { id: "phi-union", name: "Philadelphia Union", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/9/98/Philadelphia_Union_2018_logo.svg/200px-Philadelphia_Union_2018_logo.svg.png", primaryColor: "#071B2C", secondaryColor: "#B18500", city: "Chester", abbreviation: "PHI" },
  { id: "por-timbers", name: "Portland Timbers", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/f/f7/Portland_Timbers_logo.svg/200px-Portland_Timbers_logo.svg.png", primaryColor: "#004812", secondaryColor: "#EBE72B", city: "Portland", abbreviation: "POR" },
  { id: "rsl", name: "Real Salt Lake", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/3/3e/Real_Salt_Lake_2010.svg/200px-Real_Salt_Lake_2010.svg.png", primaryColor: "#B30838", secondaryColor: "#013A81", city: "Sandy", abbreviation: "RSL" },
  { id: "sj-quakes", name: "San Jose Earthquakes", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/9/98/San_Jose_Earthquakes_2014.svg/200px-San_Jose_Earthquakes_2014.svg.png", primaryColor: "#0067B1", secondaryColor: "#000000", city: "San Jose", abbreviation: "SJ" },
  { id: "sea-sounders", name: "Seattle Sounders FC", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/2/27/Seattle_Sounders_FC.svg/200px-Seattle_Sounders_FC.svg.png", primaryColor: "#005695", secondaryColor: "#658D1B", city: "Seattle", abbreviation: "SEA" },
  { id: "skc", name: "Sporting Kansas City", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/5/5f/Sporting_Kansas_City_logo.svg/200px-Sporting_Kansas_City_logo.svg.png", primaryColor: "#002B5C", secondaryColor: "#91B0D5", city: "Kansas City", abbreviation: "SKC" },
  { id: "stl-city", name: "St. Louis City SC", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/e/e7/St._Louis_City_SC_logo.svg/200px-St._Louis_City_SC_logo.svg.png", primaryColor: "#D2263C", secondaryColor: "#0F2044", city: "St. Louis", abbreviation: "STL" },
  { id: "tor-fc", name: "Toronto FC", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/4/46/Toronto_FC_Logo.svg/200px-Toronto_FC_Logo.svg.png", primaryColor: "#B81137", secondaryColor: "#455560", city: "Toronto", abbreviation: "TOR" },
  { id: "van-whitecaps", name: "Vancouver Whitecaps FC", leagueId: "mls", logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/5/5d/Vancouver_Whitecaps_FC_logo.svg/200px-Vancouver_Whitecaps_FC_logo.svg.png", primaryColor: "#00245E", secondaryColor: "#9DC2EA", city: "Vancouver", abbreviation: "VAN" }
];
...
// trpc/routes/sportsdata.ts
var sportsdataRouter = createTRPCRouter({
  // Returns merged, normalized, home-only schedules for all teams in a league
  getLeagueScheduleAllTeams: publicProcedure.input(objectType({ leagueId: stringType() })).query(async ({ input, ctx }) => {
    let key;
    ...
    } else if (typeof globalThis !== "undefined" && globalThis.SPORTSDATA_API_KEY) {
      key = globalThis.SPORTSDATA_API_KEY;
    }
    if (!key) {
    ...
    const log = /* @__PURE__ */ __name((...args) => console.log("[SDIO]", ...args), "log");
    const result = await loadLeagueScheduleAllTeams(leagueKey, key, log);
    testHomeFiltering(result);
    ...
    const homeGamesByTeamWithMeta = {};
    for (const t2 of teams) {
      homeGamesByTeamWithMeta[t2.abbreviation] = {
        team: t2,
        games: result.homeGamesByTeam[t2.abbreviation] || []
      };
    }
    return {
...
app.get("/__debug", async (c) => {
  try {
    ...
    return c.json({ url: c.req.url, query: q });
  } catch (e) {
